    ...
    <head>
        ...
        <body>
          ...
          <nav class="navbar navbar-inverse bg-info">
            ...
            <a class="navbar-brand offset-sm-1" href="#">3WireCMS</a>

            <div class="navbar-toggleable-sm collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav offset-sm-1">
...
<!-- https://medium.com/@tadaspaplauskas/using-bootstrap-4-with-laravel-5-3-8d4efb8b82bf#.s1ijapdee  -->
